    ...
    >
      ...
      {!collapsed ? (
        <div className="px-3 pt-3">
          <button onClick={onSearchClick} className="flex items-center gap-2 px-3 py-1.5 rounded-md border border-mesh-border text-sm text-mesh-muted cursor-pointer hover:border-mesh-border-hover transition-colors w-full" aria-label="Search">
        ...
        <div className="px-3 pt-3 flex justify-center">
          <button onClick={onSearchClick} className="p-2 text-mesh-muted hover:text-mesh-text transition-colors" aria-label="Search">
