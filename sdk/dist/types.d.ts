 ...
 * SDK event types
 */
export type SDKEventType = 'upload:start' | 'upload:progress' | 'upload:complete' | 'upload:error' | 'download:start' | 'download:progress' | 'download:complete' | 'download:error' | 'connection:established' | 'connection:lost' | 'peer:connected' | 'peer:disconnected';
/**
 * SDK event
 */
